...
Script that trains the yolo lstm flow model with prediction after the pretraining.
"""
...
if __name__ == "__main__":
    ...
    check_point_encoder = torch.load('./models/yolo_lstm_flow_832_encoder_pretrained.tar', map_location=opt.device())
    check_point_decoder = torch.load('./models/yolo_lstm_flow_832_decoder_pretrained.tar', map_location=opt.device())
